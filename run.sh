if [ $# -eq 2 ]; then
    ...
    do_training='train'
    development_dataset='data/test.hdf5'
...
if [ $do_training = 'train' ]; then
    ...
    # development
    python -u ./code/1-development/train_softmax.py --num_epochs=10 --batch_size=3 --development_dataset_path=$development_dataset --train_dir=results/TRAIN_CNN_3D/train_logs
